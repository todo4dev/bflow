// infrastructure/database/postgres/client.go
package postgres
...
func (c *Client) Query(ctx context.Context, query string, args ...any) (port.Rows, error) {
...
func (c *Client) QueryRow(ctx context.Context, query string, args ...any) port.Row {
	return c.conn().QueryRow(ctx, query, args...)
}

func (c *Client) Exec(ctx context.Context, query string, args ...any) (port.Result, error) {
...
func (c *Client) Transaction(ctx context.Context, fn func(tx port.Client) error) error {
	if c.tx != nil {
