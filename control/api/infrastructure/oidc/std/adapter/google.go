// infrastructure/oidc/std/adapter/google.go
package adapter
...
var _ oidc.Adapter = (*HttpGoogle)(nil)
...
func (g *HttpGoogle) GetAuthURL(state map[string]any) string {
...
func (g *HttpGoogle) GetInfo(ctx context.Context, accessToken string) (*oidc.Claims, error) {
	...
	claims.Custom["picture"] = data.Picture
...
func (g *HttpGoogle) GetPicture(ctx context.Context, accessToken string) (io.ReadCloser, error) {
	...
	req, err := http.NewRequestWithContext(ctx, "GET", claims.Custom["picture"].(string), nil)
	if err != nil {
		return nil, err
	}
